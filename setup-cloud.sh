...
echo ""
read -r -p "Press Enter when you have created an account..."

echo ""
echo "Step 2: Create organization 'alvit'"
echo "  → Open: https://app.terraform.io/app/organizations/new"
echo "  → Organization name: alvit"
echo ""
read -r -p "Press Enter when organization is created..."
...
echo "  → Open: https://app.terraform.io/app/alvit/workspaces/github-infrastructure/variables"
echo ""
echo "  Add these variables:"
echo "    - github_token (sensitive) = your GitHub PAT"
echo "    - billing_email (sensitive) = your email"
echo ""
read -r -p "Press Enter when variables are configured..."
...
echo ""
echo "Workspace URL:"
echo "  https://app.terraform.io/app/alvit/workspaces/github-infrastructure"
echo ""
echo "Commands:"
