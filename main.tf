...
resource "github_repository" "inverter_control" {
  ...
  topics = [
    ...
    "external-control", "grid-tie", "hass", "home-assistant", "mqtt",
    "python", "quattro", "raspberry-pi", "solar", "venus-os", "victron", "vm-3p75ct"
  ]
...
resource "github_repository" "venus_os_observability" {
  ...
  topics = [
    ...
    "opentelemetry", "prometheus", "python", "tempo", "venus-os", "victron"
  ]
...
resource "github_repository" "inverter_monitoring" {
  ...
  topics = [
    ...
    "iot", "mqtt", "python", "telegraf", "time-series", "venus-os", "victron"
  ]
...
resource "github_repository" "integration_tests" {
  ...
  topics = [
    "ci", "integration-tests", "mqtt", "python", "testing", "venus-os", "victron"
  ]
...
resource "github_repository" "venus_os_governance" {
  ...
  topics = [
    ...
    "policy-engine", "python", "soc-limits", "venus-os", "victron"
  ]
...
resource "github_repository" "dbus_virtual_battery" {
  ...
  topics = [
    "battery", "simulator", "test", "venus-os", "victron", "dbus", "mqtt"
  ]
